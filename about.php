...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <li ><a href="index.php">Home</a></li>
        ...
        <li id="rightmenu"><a href="about.php" style="background-color:orange">About</a></li>
	 ...
	 <a href="addabout.php" class="btn btn-success">Add about us</a>
...
echo "<td><a href='about_edit.php?id=".$row['id']."' class='btn btn-info'>edit</a></td>";

echo "<td><a href='about_delete.php?id=".$row['id']."' class='btn btn-danger'>Delete</a></td>";
